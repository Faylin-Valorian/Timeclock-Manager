            ...
            <div class="modal-body">
                <div class="form-section">
                    ...
                    <div class="form-row-1" style="margin-top: 10px;">
                        <div class="input-group">
                            ...
                            <input type="text" id="total-hours" class="form-control" readonly style="font-weight: bold; text-align: right;">
                        </div>
                    </div>
                </div>
                ...
                <div id="travel-fields-container" class="travel-box hidden-section">
                    ...
                    <div class="form-row-3">
                        <div class="input-group"><label>State</label><input list="state-options" id="travel-state" class="form-control"><datalist id="state-options"></datalist></div>
                        <div class="input-group"><label>County</label><input id="travel-county" class="form-control"></div>
